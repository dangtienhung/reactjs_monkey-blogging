...
import {
  ...
  PostImage,
  PostMeta,
} from '../../../modules/posts/layout';
import { Heading } from '../../layouts';
import PostItems from '../../../modules/posts/PostItems';
        ...
        <div className="container">
          <div className="post-header">
            ...
            <div className="post-info">
              <PostCatygory className="mb-6">Kiến thức</PostCatygory>
          ...
          <div className="post-content">
            ...
            <div className="author">
              ...
              <div className="author-content">
                <h3 className="author-name">DangTienHung</h3>
